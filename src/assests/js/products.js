...
const products = [
  ...
  new Product(
    "Real Mosaic",
    "/assests/img/products/product03.svg",
    "REAL",
    "Ce skateboard complet est parfait pour les patineurs de tous niveaux. Pré-assemblé et prêt à rouler, fini avec du ruban adhésif noir, des roues de marque blanche et des trucks en aluminium.",
    129.95
  ),
  new Product(
    "Antihero Budgie",
    "/assests/img/products/product04.svg",
    "ANTIHERO",
    "Ce skateboard complet est parfait pour les patineurs de tous niveaux. Pré-assemblé et prêt à rouler, fini avec du ruban adhésif noir, des roues de marque blanche et des trucks en aluminium.",
    129.95
  ),
  ...
  new Product(
    ...
    "/assests/img/products/product06.svg",
    "LANDYACHTZ",
  ...
  new Product(
    ...
    "/assests/img/products/product07.svg",
    "LANDYACHTZ",
  ...
  new Product(
    ...
    "/assests/img/products/vedette01.svg",
    "LANDYACHTZ",
  ...
  new Product(
    ...
    "/assests/img/products/vedette02.svg",
    " Skatebard Deck 8",
  ...
  new Product(
    ...
    "/assests/img/products/vedette03.svg",
